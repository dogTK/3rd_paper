...
# Print the table
print(df_down[, c("Category", "ID", "Description", "Count", "Percentage", "p.adjust")])

setwd("~/Desktop/研究/3rd_paper/enrichment/all/result/GO")

write_csv(df_down[, c("Category", "ID", "Description", "Count", "Percentage", "p.adjust")],file = "table_down.csv")
